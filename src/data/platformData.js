...
export const pageCopy = {
  ...
  liveOrder: text('Live-Bestellung', 'Live order', 'رهگیری زنده سفارش', 'تتبع الطلب المباشر'), restaurant: text('Restaurant Workspace', 'Restaurant workspace', 'پنل رستوران', 'مساحة إدارة المطعم'),
